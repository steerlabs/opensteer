...
const ROOT_COMMANDS: readonly CliCommandDefinition[] = [
  ...
  {
    name: "reverse",
    summary: "Solve, replay, export, and inspect reverse-engineering packages.",
    ...
    subcommands: [
      {
        ...
        options: [
          ...
          {
            name: "key",
            description: "Case key for a new solve run",
            kind: "string",
            valueLabel: "key",
          },
          {
          ...
          { name: "notes", description: "Solve notes", kind: "string", valueLabel: "text" },
          {
            name: "page-ref",
            description: "Page reference to solve from",
            kind: "string",
            valueLabel: "ref",
          },
          {
            name: "state-source",
            description: "State source classification for this solve run",
            kind: "enum",
            valueLabel: "kind",
          ...
          },
          {
            ...
            description: "How strongly solve should assume manual unlock calibration is acceptable",
            kind: "enum",
            valueLabel: "mode",
          ...
          },
          {
            ...
            description: "Maximum ranked candidates to retain",
            kind: "number",
            valueLabel: "count",
            internalName: "candidateLimit",
          },
          {
            name: "max-replay-attempts",
            description: "Maximum live replay attempts during solve",
            kind: "number",
            valueLabel: "count",
            internalName: "maxReplayAttempts",
          },
        ],
      },
      {
        name: "replay",
        id: "reverse.replay",
        summary: "Replay a reverse package.",
        options: [
          ...SESSION_OPTIONS,
          OUTPUT_OPTION,
          {
      ...
      },
      {
        name: "report",
        id: "reverse.report",
        summary: "Read the generated reverse-engineering report for a package.",
        options: [
          ...SESSION_OPTIONS,
          OUTPUT_OPTION,
          {
      ...
      {
        name: "package",
        summary: "Inspect and patch reverse packages.",
        subcommands: [
          {
            name: "get",
          ...
          },
          {
            ...
            options: [
              ...
              {
                name: "candidate-id",
                description: "Override selected candidate",
                kind: "string",
                valueLabel: "id",
              ...
              {
                name: "strategy-id",
                description: "Override selected strategy",
                kind: "string",
                valueLabel: "id",
                internalName: "strategyId",
              },
              {
                name: "workflow-json",
