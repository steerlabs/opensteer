...
export function compareReverseAnalysisResults(
  left: Pick<ReverseAnalysisResult, "signals" | "matchedTargetHints" | "boundary" | "advisoryTags">,
  right: Pick<
    ReverseAnalysisResult,
...
function portabilityWeight(dependencyClass: ReverseCandidateDependencyClass): number {
